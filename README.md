# AgentForge - Parallel Agent Based Simulation on GPUs                                                          


Agent Forge is a GPU accelerated agent-based simulation library for domain independent complex systems simulations.
